...
Semantic Search: Retrieve most relevant document chunks using vector similarity
LLM Integration: Generate accurate answers using GPT models via LiteLLM
Cost Tracking: Monitor API usage costs
Clean Architecture: Object-oriented design with separation of concerns
